...
const customIcon = (
  <svg viewBox='0 0 24 24' fill='none' xmlns='http://www.w3.org/2000/svg'>
    ...
    <g id='SVGRepo_iconCarrier'>
      ...
      ></path>{' '}
      <path
        d='M11.2944 9.35279L11.7105 9.14472C11.8435 9.07823 12 9.17493 12 9.32361V16C12 16.5523 12.4477 17 13 17C13.5523 17 14 16.5523 14 16V8C14 7.44772 13.5523 7 13 7H12.2361C12.0808 7 11.9277 7.03615 11.7888 7.10557L10.4944 7.75279C10.1914 7.9043 9.99999 8.214 9.99999 8.55279C9.99999 9.21769 10.6997 9.65014 11.2944 9.35279Z'
        fill='#0F0F0F'
      ></path>{' '}
    </g>
  </svg>
...
// Register block
registerBlockType('multiple-blocks/block1', {
  apiVersion: 2,
  title: 'Block 1',
  icon: customIcon,
  category: 'blocks',

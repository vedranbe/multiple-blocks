...
const customIcon = (
  <svg viewBox='0 0 24 24' fill='none' xmlns='http://www.w3.org/2000/svg'>
    ...
    <g id='SVGRepo_iconCarrier'>
      ...
      ></path>{' '}
      <path
        d='M11 7H13C14.1046 7 15 7.89543 15 9V10.1716C15 10.702 14.7893 11.2107 14.4142 11.5858L14.1414 11.8586C14.0633 11.9367 14.0633 12.0633 14.1414 12.1414L14.4142 12.4142C14.7893 12.7893 15 13.298 15 13.8284V15C15 16.1046 14.1046 17 13 17H11C9.89542 17 8.99999 16.1046 8.99999 15C8.99999 14.4477 9.4477 14 9.99999 14H10.5C10.7761 14 11 14.2239 11 14.5C11 14.7761 11.2238 15 11.5 15H12C12.5523 15 13 14.5523 13 14C13 13.4477 12.5523 13 12 13C11.4477 13 11 12.5523 11 12C11 11.4477 11.4477 11 12 11C12.5523 11 13 10.5523 13 10C13 9.44772 12.5523 9 12 9H11.5C11.2238 9 11 9.22386 11 9.5C11 9.77614 10.7761 10 10.5 10H9.99999C9.4477 10 8.99999 9.55228 8.99999 9C8.99999 7.89543 9.89542 7 11 7Z'
        fill='#0F0F0F'
      ></path>{' '}
    </g>
  </svg>
...
// Register block
registerBlockType('multiple-blocks/block3', {
  apiVersion: 2,
  title: `Block 3`,
  icon: customIcon,
  category: 'blocks',
